	...
	<div class="right-cont">
		...
		<form method="post" action="<?php echo $this->Url->build(["controller"=>"Patients","action"=>"save"]); ?>" enctype="multipart/form-data">
			...
			<section class=" patient-info patient-health lightblue-bg mb-2 float-left w-100 p-4">
				...
				<section class="form-control-row float-left w-100">
					<h4>Chronic Conditions:<span class="starClass"> *</span></h4>
					<?php
				...
				<section class="form-extend chf mt-4 float-left w-100 vitalDetails_1 <?php echo isset($savedVitals) && in_array(1,$savedVitals) ? "active" : ""; ?> ">
					<section class="form-control-row float-left w-100">
						<h4>Blood Pressure</h4>
						<section class="items float-none d-inline-block align-middle">
							<label class="mr-2"><b>Normal<span class="starClass"> *</span></b></label>
						</section>
						<section class="items float-none d-inline-block align-middle">
							<label class="mr-2">Systolic</label>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text bpNormalMinSystolic_1 bpInputValidation" name="bp_normal_min[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["normal_min"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text bpNormalMaxSystolic_1 bpInputValidation" name="bp_normal_max[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["normal_max"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
						</section>
						<section class="items float-none d-inline-block align-middle">
							...
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text bpNormalMinDiastolic_1 bpInputValidation" name="bp_normal_min[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][1]["normal_min"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text bpNormalMaxDiastolic_1 bpInputValidation" name="bp_normal_max[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][1]["normal_max"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
						</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<textarea placeholder="Intervention Notes" name="bp_intervention_notes" class="interventionNotes_1 bpInputValidation"><?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["intervention_notes"] : ""; ?></textarea>
						<span class="errorClass">Field Required</span>
					</section>
					
					<section class="form-control-row float-left w-100 mt-3">
						<section class="items float-none d-inline-block align-middle">
							<label class="mt-3 mr-4"><b>Warning<span class="starClass"> *</span></b></label>
						</section>
						<section class="items float-none d-inline-block align-middle">
							<div class="w-100">
							...
							<label class="mr-2">Systolic</label>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text bpWarningMinSystolic_1 bpInputValidation" name="bp_warning_min[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["warning_min"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text bpWarningMaxSystolic_1 bpInputValidation" name="bp_warning_max[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["warning_max"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
						</section>
						<section class="items float-none d-inline-block align-middle">
							...
							<label class="mr-2">Diastolic</label>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text bpWarningMinDiastolic_1 bpInputValidation" name="bp_warning_min[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][1]["warning_min"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text bpWarningMaxDiastolic_1 bpInputValidation" name="bp_warning_max[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][1]["warning_max"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
						</section>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<section class="items float-none d-inline-block align-middle">
							<label class="mr-2"><b>Emergency<span class="starClass"> *</span></b></label>
						</section>
						<section class="items float-none d-inline-block align-middle">
							<label class="mr-2">Systolic</label>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text bpEmergencyMinSystolic_1 bpInputValidation" name="bp_emergency_min[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["emergency_min"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text bpEmergencyMaxSystolic_1 bpInputValidation" name="bp_emergency_max[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][0]["emergency_max"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
						</section>
						<section class="items float-none d-inline-block align-middle">
							<label class="mr-2">Diastolic</label>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text bpEmergencyMinDiastolic_1 bpInputValidation" name="bp_emergency_min[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][1]["emergency_min"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
							<div class="d-inline-block">
								<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text bpEmergencyMaxDiastolic_1 bpInputValidation" name="bp_emergency_max[]" value="<?php echo !empty($bpKeyFinal) ? $patientData["patientvitalsettings"][1]["emergency_max"] : ""; ?>" >
								<span class="errorClass">Field Required</span>
							</div>
						</section>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label>Frequency<span class="starClass"> *</span></label>
						<select name="bp_measure_frequency" class="bpSelectValidation">
							<option value="">Select</option>
							<option value="1" <?php echo isset($patientData["patientvitalsettings"]) && $patientData["patientvitalsettings"][0]["measure_frequency"]==1 ? "selected" : ""; ?> >1 time a day</option>
						...
						<span class="errorClass bpSelectErrorClass">Field Required</span>
					</section>
				</section>
				<!-- BLOOD PRESSURE DIV -->
				
				<!-- PULSE DIV -->
				<?php $pulseKey = isset($savedVitals) && !empty($savedVitals) && in_array(3,$savedVitals) ? array_search(3,$savedVitals) : ""; ?>
				<section class="form-extend astma mt-4 float-left w-100 vitalDetails_3 <?php echo isset($savedVitals) && in_array(3,$savedVitals) ? "active" : ""; ?> ">
					<section class="form-control-row float-left w-100">
						<h4>PULSE</h4>
						<label class="mr-2">Normal<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text normalMin_3 pulseInputValidation" name="pulse_normal_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["normal_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text normalMax_3 pulseInputValidation" name="pulse_normal_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["normal_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<textarea placeholder="Intervention Notes" name="pulse_intervention_notes" class="interventionNotes_3 pulseInputValidation"><?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["intervention_notes"] : ""; ?></textarea>
						<span class="errorClass">Field Required</span>
					</section>
					
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-4">Warning<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text warningMin_3 pulseInputValidation" name="pulse_warning_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["warning_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text warningMax_3 pulseInputValidation" name="pulse_warning_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["warning_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-2">Emergency<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text emergencyMin_3 pulseInputValidation" name="pulse_emergency_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["emergency_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text emergencyMax_3 pulseInputValidation" name="pulse_emergency_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$pulseKey]["emergency_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>

					<section class="form-control-row float-left w-100 mt-3">
						<label>Frequency<span class="starClass"> *</span></b></label>
						<select name="pulse_measure_frequency" class="pulseSelectValidation">
							<option value="">Select</option>
							<option value="1" <?php echo isset($patientData["patientvitalsettings"]) && $patientData["patientvitalsettings"][$pulseKey]["measure_frequency"]==1 ? "selected" : ""; ?> >1 time a day</option>
						...
						<span class="errorClass pulseSelectErrorClass">Field Required</span>
					</section>
				</section>
				<!-- PULSE DIV -->
				
				<!-- WEIGHT DIV -->
				<?php $weightKey = isset($savedVitals) && !empty($savedVitals) && in_array(4,$savedVitals) ? array_search(4,$savedVitals) : ""; ?>
				<section class="form-extend diabetes mt-4 float-left w-100 vitalDetails_4 <?php echo isset($savedVitals) && in_array(4,$savedVitals) ? "active" : ""; ?> ">
					<section class="form-control-row float-left w-100">
						<h4>WEIGHT</h4>
						<label class="mr-2">Normal<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text normalMin_4 weightInputValidation" name="weight_normal_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["normal_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text normalMax_4 weightInputValidation" name="weight_normal_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["normal_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<textarea placeholder="Intervention Notes" name="weight_intervention_notes" class="interventionNotes_4 weightInputValidation"><?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["intervention_notes"] : ""; ?></textarea>
						<span class="errorClass">Field Required</span>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-4">Warning<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text warningMin_4 weightInputValidation" name="weight_warning_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["warning_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text warningMax_4 weightInputValidation" name="weight_warning_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["warning_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-2">Emergency<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text emergencyMin_4 weightInputValidation" name="weight_emergency_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["emergency_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text emergencyMax_4 weightInputValidation" name="weight_emergency_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$weightKey]["emergency_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label>Frequency<span class="starClass"> *</span></b></label>
						<select name="weight_measure_frequency" class="weightSelectValidation">
							<option value="">Select</option>
							<option value="1" <?php echo isset($patientData["patientvitalsettings"]) && $patientData["patientvitalsettings"][$weightKey]["measure_frequency"]==1 ? "selected" : ""; ?> >1 time a day</option>
						...
						<span class="errorClass weightSelectErrorClass">Field Required</span>
					</section>
				</section>
				<!-- WEIGHT DIV -->
				
				<!-- SPO2 DIV -->
				<?php $spoKey = isset($savedVitals) && !empty($savedVitals) && in_array(5,$savedVitals) ? array_search(5,$savedVitals) : ""; ?>
				<section class="form-extend hypertension mt-4 float-left w-100 vitalDetails_5 <?php echo isset($savedVitals) && in_array(5,$savedVitals) ? "active" : ""; ?> ">
					<section class="form-control-row float-left w-100">
						<h4>SPO2</h4>
						<label class="mr-2">Normal<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text normalMin_5 spoInputValidation" name="spo_normal_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["normal_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text normalMax_5 spoInputValidation" name="spo_normal_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["normal_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<textarea placeholder="Intervention Notes" name="spo_intervention_notes" class="interventionNotes_5 spoInputValidation"><?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["intervention_notes"] : ""; ?></textarea>
						<span class="errorClass">Field Required</span>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-4">Warning<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text warningMin_5 spoInputValidation" name="spo_warning_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["warning_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text warningMax_5 spoInputValidation" name="spo_warning_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["warning_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-2">Emergency<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text emergencyMin_5 spoInputValidation" name="spo_emergency_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["emergency_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text emergencyMax_5 spoInputValidation" name="spo_emergency_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$spoKey]["emergency_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label>Frequency<span class="starClass"> *</span></b></label>
						<select name="spo_measure_frequency" class="spoSelectValidation">
							<option value="">Select</option>
							<option value="1" <?php echo isset($patientData["patientvitalsettings"]) && $patientData["patientvitalsettings"][$spoKey]["measure_frequency"]==1 ? "selected" : ""; ?> >1 time a day</option>
						...
						<span class="errorClass spoSelectErrorClass">Field Required</span>
					</section>
				</section>
				<!-- SPO2 DIV -->
				
				<!-- GLUCOSE DIV -->
				<?php $glucoseKey = isset($savedVitals) && !empty($savedVitals) && in_array(6,$savedVitals) ? array_search(6,$savedVitals) : ""; ?>
				<section class="form-extend glucos mt-4 float-left w-100 vitalDetails_6 <?php echo isset($savedVitals) && in_array(6,$savedVitals) ? "active" : ""; ?> ">
					<section class="form-control-row float-left w-100">
						<h4>GLUCOSE</h4>
						<label class="mr-2">Normal<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text normalMin_6 glucoseInputValidation" name="glucose_normal_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["normal_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text normalMax_6 glucoseInputValidation" name="glucose_normal_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["normal_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>

						<input type="checkbox" name="template" class="templateData" id="6">
						<label>Standard template</label>
					</section>

					<section class="form-control-row float-left w-100 mt-3">
						<textarea placeholder="Intervention Notes" name="glucose_intervention_notes" class="interventionNotes_6 glucoseInputValidation"><?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["intervention_notes"] : ""; ?></textarea>
						<span class="errorClass">Field Required</span>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-4">Warning<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text warningMin_6 glucoseInputValidation" name="glucose_warning_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["warning_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text warningMax_6 glucoseInputValidation" name="glucose_warning_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["warning_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label class="mr-2">Emergency<span class="starClass"> *</span></b></label>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Min." class="mr-3 value-text emergencyMin_6 glucoseInputValidation" name="glucose_emergency_min" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["emergency_min"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
						<div class="d-inline-block">
							<input autocomplete="off" type="text" placeholder="Max." class="mr-4 value-text emergencyMax_6 glucoseInputValidation" name="glucose_emergency_max" value="<?php echo isset($patientData["patientvitalsettings"]) ? $patientData["patientvitalsettings"][$glucoseKey]["emergency_max"] : ""; ?>" >
							<span class="errorClass">Field Required</span>
						</div>
					</section>
					...
					<section class="form-control-row float-left w-100 mt-3">
						<label>Frequency<span class="starClass"> *</span></b></label>
						<select name="glucose_measure_frequency" class="glucoseSelectValidation">
							<option value="">Select</option>
							<option value="1" <?php echo isset($patientData["patientvitalsettings"]) && $patientData["patientvitalsettings"][$glucoseKey]["measure_frequency"]==1 ? "selected" : ""; ?> >1 time a day</option>
						...
						<span class="errorClass glucoseSelectErrorClass">Field Required</span>
					</section>
				</section>
				<!-- GLUCOSE DIV -->
			...
			<section class="patient-info patient-device lightblue-bg mb-2 float-left w-100 p-4">
				...
				<section class="half-width">
					...
					<div class="items float-none d-inline-block align-bottom mr-3">
						...
						<label ><?php echo $value["device_name"]." (".$value["device_manufacturer"].")"; ?></label>
...
$(document).ready(function()
{
	...
	$(".vital_id").click(function()
	{
		...
		$(".vitalDetails_"+$(this).attr("id")).toggleClass("active");
...
$(document).ready(function() {
	...
	$(add_button).click(function(e){ //on add input button click
		...
		//$(wrapper).append('<div><label>First Name</label><input type="name" name="mytext[]" placeholder=""/><label>Last Name</label> <input type="text" name="mytext[]" placeholder=""/> <label>EMail</label><input type="text" name="mytext[]" placeholder=""/><label>Phone</label><input type="text" name="mytext[]" placeholder=""/><a href="#" class="remove_field">Remove</a></div>'); //add input box
			$(wrapper).append('<div class="full-items caregiverDiv caregiverDiv_'+x+'"><section class="items float-none d-inline-block align-middle"><label>First Name<span class="starClass"> *</span></label><input autocomplete="off" type="text" placeholder="First Name" name="caregiver_fname[]" class="caregiverFname"><span class="errorClass caregiverFnameErrorClass">Field Required</span></section><section class="items float-none d-inline-block align-middle"><label>Last Name<span class="starClass"> *</span></label><input autocomplete="off" type="text" placeholder="Last Name" name="caregiver_lname[]" class="caregiverLname"><span class="errorClass caregiverLnameErrorClass">Field Required</span></section><section class="items float-none d-inline-block align-middle"><label>Email<span class="starClass"> *</span></label><input autocomplete="off" type="text" placeholder="Email" name="caregiver_email[]" class="caregiverEmail"><span class="errorClass caregiverEmailErrorClass">Field Required</span></section><section class="items float-none d-inline-block align-middle"><label>Phone<span class="starClass"> *</span></label><select class="col-md-4 mr-2 float-left" name="caregiver_phone_code[]"><option value="+1">+1</option><option value="+91">+91</option></select><input autocomplete="off" type="text" placeholder="Phone" name="caregiver_phone[]" maxlength="10" class="caregiverPhone" class="caregiverPhone" style="width:45% !important;"><span class="errorClass caregiverPhoneErrorClass">Field Required</span></section><section class="items float-none d-inline-block align-middle"><label class="mr-3"><input type="radio" name="is_primary[]" value="'+x+'" class="is_primary" > Primary Contact <span class="radiobtn"></span></label></section><a href="#" class="remove_field" id="" data-id="'+x+'">Remove</a></div>'); //add input box
			}
	});
	...
	$("body").on("click",".deviceID",function()
	{
		$(".deviceErrorClass").css("display","none");
	});
	
	$("body").on("blur",".bpInputValidation, .pulseInputValidation, .weightInputValidation, .spoInputValidation, .glucoseInputValidation",function()
	{
		$(this).next(".errorClass").css("display","none");
	});
	
	$("body").on("change",".bpSelectValidation, .pulseSelectValidation, .weightSelectValidation, .spoSelectValidation, .glucoseSelectValidation",function()
	{
		$(this).next(".errorClass").css("display","none");
	});
		...
		if($nonempty.length!=0)
		{
			$(".vitalIDText").each(function()
			{
				if($(this).val()==1)
				{
					...
					$(".bpInputValidation").each(function()
					{
						if($(this).val()=="")
						{
							$(this).next(".errorClass").css("display","block");
							
							if($(".bpSelectValidation").val()=="")
							{
								$(".bpSelectErrorClass").css("display","block");
							}
						}
						else
						{
				...
				if($(this).val()==3)
				{
					...
					$(".pulseInputValidation").each(function()
					{
						if($(this).val()=="")
						{
							$(this).next(".errorClass").css("display","block");
							
							if($(".pulseSelectValidation").val()=="")
							{
								$(".pulseSelectErrorClass").css("display","block");
							}
						}
						else
						{
				...
				if($(this).val()==4)
				{
					...
					$(".weightInputValidation").each(function()
					{
						if($(this).val()=="")
						{
							$(this).next(".errorClass").css("display","block");
							
							if($(".weightSelectValidation").val()=="")
							{
								$(".weightSelectErrorClass").css("display","block");
							}
						}
						else
						{
				...
				if($(this).val()==5)
				{
					...
					$(".spoInputValidation").each(function()
					{
						if($(this).val()=="")
						{
							$(this).next(".errorClass").css("display","block");
							
							if($(".spoSelectValidation").val()=="")
							{
								$(".spoSelectErrorClass").css("display","block");
							}
						}
						else
						{
				...
				if($(this).val()==6)
				{
					...
					$(".glucoseInputValidation").each(function()
					{
						if($(this).val()=="")
						{
							$(this).next(".errorClass").css("display","block");
							
							if($(".glucoseSelectValidation").val()=="")
							{
								$(".glucoseSelectErrorClass").css("display","block");
							}
						}
						else
						{
				...
				success: function(data)
				{
					...
					if(obj!="")
					{
						jQuery.each(obj, function(key, val)
						{
							...
							if(id==1)
							{
								$(".bpInputValidation").next().css("display","none");
							}
							if(id==3)
							{
								$(".pulseInputValidation").next().css("display","none");
							}
							if(id==4)
							{
								$(".weightInputValidation").next().css("display","none");
							}
							if(id==5)
							{
								$(".spoInputValidation").next().css("display","none");
							}
							if(id==6)
							{
								$(".glucoseInputValidation").next().css("display","none");
							}
						});
					}
				}   
